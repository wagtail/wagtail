...
* :meth:`~wagtail.core.models.Page.get_root_relative_url()`

If you find the feature to be a poor fit for your project, you can disabled it by adding the following to your project settings:
