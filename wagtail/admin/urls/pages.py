...
urlpatterns = [
    ...
    url(
        r"^add/(\w+)/(\w+)/(\d+)/preview/$",
        pages.PreviewOnCreate.as_view(),
        name="preview_on_add",
    ),
    url(r"^usage/(\w+)/(\w+)/$", pages.content_type_use, name="type_use"),
    url(r"^(\d+)/edit/$", pages.edit, name="edit"),
    url(
        r"^(\d+)/edit/preview/$", pages.PreviewOnEdit.as_view(), name="preview_on_edit"
    ),
    ...
    url(
        r"^moderation/(\d+)/approve/$",
        pages.approve_moderation,
        name="approve_moderation",
    ),
    url(
        r"^moderation/(\d+)/reject/$", pages.reject_moderation, name="reject_moderation"
    ),
    url(
        r"^moderation/(\d+)/preview/$",
        pages.preview_for_moderation,
    ...
    url(
        r"^(\d+)/revisions/(\d+)/revert/$",
        pages.revisions_revert,
        name="revisions_revert",
    ),
    url(
        r"^(\d+)/revisions/(\d+)/unschedule/$",
        pages.revisions_unschedule,
        name="revisions_unschedule",
    ),
    url(
        r"^(\d+)/revisions/compare/(live|earliest|\d+)\.\.\.(live|latest|\d+)/$",
        pages.revisions_compare,
