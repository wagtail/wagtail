...
from wagtail.test.testapp.models import (
    MultiPreviewModesSiteSetting,
    NonPreviewableSiteSetting,
...
class TestEnablePreview(WagtailTestUtils, TestCase):
    def setUp(self):
        ...
        self.multiple = MultiPreviewModesSiteSetting.objects.create(
            text="Multiple preview modes", site=self.other_site
        )
...
class TestDisablePreviewWithEmptyModes(WagtailTestUtils, TestCase):
    ...
    # NonPreviewableSiteSetting has preview_modes = []
    model = NonPreviewableSiteSetting

    def setUp(self):
        self.user = self.login()
        self.setting = self.model.objects.create(text="A non-previewable site setting")
