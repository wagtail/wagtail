...
describe('admin/privacy-switch entrypoint', () => {
  ...
  it('re-binds triggers when w-autosave:success is dispatched', () => {
    const newButton = document.createElement('button');
    newButton.setAttribute('data-a11y-dialog-show', 'set-privacy');
    newButton.setAttribute('data-url', '/new-privacy-url/');
