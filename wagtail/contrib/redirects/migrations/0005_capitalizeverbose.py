...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='redirect',
            name='site',
            field=models.ForeignKey(on_delete=models.CASCADE, blank=True, related_name='redirects', null=True, to=swapper.get_model_name('wagtailcore', 'Site'), verbose_name='site'),
