...
Many thanks to Seoyoung Kang from AhnLab for reporting this issue. For further details, please see [the CVE-2026-44197 security advisory](https://github.com/wagtail/wagtail/security/advisories/GHSA-c6wj-9vcj-75pj).
...
Many thanks to Seoyoung Kang from AhnLab for reporting this issue. For further details, please see [the CVE-2026-44198 security advisory](https://github.com/wagtail/wagtail/security/advisories/GHSA-c4mr-889m-vgf6).
...
Many thanks to Vishal Shukla for reporting this issue. For further details, please see [the CVE-2026-44199 security advisory](https://github.com/wagtail/wagtail/security/advisories/GHSA-pwm3-7fv4-g6xx).
...
Many thanks to Sanjok Karki for reporting this issue. For further details, please see [the CVE-2026-44201 security advisory](https://github.com/wagtail/wagtail/security/advisories/GHSA-p5gm-92h4-6pv6).
...
Many thanks to Sanjok Karki for reporting this issue. For further details, please see [the CVE-2026-44200 security advisory](https://github.com/wagtail/wagtail/security/advisories/GHSA-67rv-mg8q-5pf3).
