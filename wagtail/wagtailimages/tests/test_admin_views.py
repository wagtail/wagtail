...
class TestImageAddView(TestCase, WagtailTestUtils):
    ...
    def get(self, params={}):
        return self.client.get(reverse('wagtailimages:create'), params)

    def post(self, post_data={}):
        return self.client.post(reverse('wagtailimages:create'), post_data)
...
class TestImageEditView(TestCase, WagtailTestUtils):
    ...
    def get(self, params={}):
        return self.client.get(reverse('wagtailimages:update', args=(self.image.id,)), params)

    def post(self, post_data={}):
        return self.client.post(reverse('wagtailimages:update', args=(self.image.id,)), post_data)
...
class TestImageChooserChosenView(TestCase, WagtailTestUtils):
    ...
    def get(self, params={}):
        return self.client.get(reverse('wagtailimages:chooser_chosen', args=(self.image.id,)), params)
...
class TestMultipleImageUploader(TestCase, WagtailTestUtils):
    ...
    def test_add(self):
        ...
        """
        # Send request
        response = self.client.get(reverse('wagtailimages:create_multiple'))
    ...
    def test_add_post(self):
        ...
        """
        response = self.client.post(reverse('wagtailimages:create_multiple'), {
    ...
    def test_add_post_nofile(self):
        ...
        """
        response = self.client.post(reverse('wagtailimages:create_multiple'), {}, HTTP_X_REQUESTED_WITH='XMLHttpRequest')
    ...
    def test_edit_get(self):
        ...
        """
        # Send request
        response = self.client.get(reverse('wagtailimages:create_multiple_update', args=(self.image.id, )))
    ...
    def test_edit_post(self):
        ...
        """
        # Send request
        response = self.client.post(reverse('wagtailimages:create_multiple_update', args=(self.image.id, )), {
    ...
    def test_delete_get(self):
        ...
        """
        # Send request
        response = self.client.get(reverse('wagtailimages:create_multiple_delete', args=(self.image.id, )))
    ...
    def test_delete_post(self):
        ...
        """
        # Send request
        response = self.client.post(reverse('wagtailimages:create_multiple_delete', args=(self.image.id, )), HTTP_X_REQUESTED_WITH='XMLHttpRequest')
    ...
    def test_edit_post_noajax(self):
        ...
        """
        # Send request
        response = self.client.post(reverse('wagtailimages:create_multiple_delete', args=(self.image.id, )))
