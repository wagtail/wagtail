...
describe('skip to the main content on clicking the skiplink', () => {
  document.body.innerHTML = `
        <a id="skip" class="button" data-controller="w-skip-link" data-action="click->w-skip-link#skipToMain">Skip to main content</a>
        <main>
            Main content
        </main>
  ...
  it('should skip to main when skiplink is clicked', () => {
