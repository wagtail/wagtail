...
Workflow.panels = [
    FieldPanel("name", heading=ugettext_lazy("Give your workflow a name")),
    InlinePanel("workflow_tasks", heading=ugettext_lazy("Add tasks to your workflow")),
]
Task.panels = [
    FieldPanel("name", heading=ugettext_lazy("Give your task a name")),
]
GroupApprovalTask.panels = Task.panels + [FieldPanel('groups', heading=ugettext_lazy("Choose approval groups"))]
