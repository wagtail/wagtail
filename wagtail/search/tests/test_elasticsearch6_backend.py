...
class TestElasticsearch6SearchQuery(TestCase):
    ...
    def test_simple(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.all(), "Hello")
    ...
    def test_none_query_string(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.all(), MATCH_ALL)
    ...
    def test_and_operator(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.all(), "Hello", operator='and')
    ...
    def test_filter(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.filter(title="Test"), "Hello")
    ...
    def test_and_filter(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.filter(title="Test", publication_date=datetime.date(2017, 10, 18)), "Hello")
    ...
    def test_or_filter(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.filter(Q(title="Test") | Q(publication_date=datetime.date(2017, 10, 18))), "Hello")
    ...
    def test_negated_filter(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.exclude(publication_date=datetime.date(2017, 10, 18)), "Hello")
    ...
    def test_fields(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.all(), "Hello", fields=['title'])
    ...
    def test_fields_with_and_operator(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.all(), "Hello", fields=['title'], operator='and')
    ...
    def test_multiple_fields(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.all(), "Hello", fields=['title', 'content'])
    ...
    def test_exact_lookup(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.filter(title__exact="Test"), "Hello")
    ...
    def test_none_lookup(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.filter(title=None), "Hello")
    ...
    def test_isnull_true_lookup(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.filter(title__isnull=True), "Hello")
    ...
    def test_isnull_false_lookup(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.filter(title__isnull=False), "Hello")
    ...
    def test_startswith_lookup(self):
        # Create a query
        query = self.get_query_compiler(models.Book.objects.filter(title__startswith="Test"), "Hello")
