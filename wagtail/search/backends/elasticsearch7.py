...
class Elasticsearch7Mapping:
    ...
    def get_mapping(self):
        ...
        fields = {
            ...
            self.edgengrams_field_name: dict(type=self.text_type),
        }
        ...
        fields[self.all_field_name] = {'type': 'text'}  # Add the _all_text field
        return {
            'properties': fields,
        }
...
class ElasticsearchAutocompleteQueryCompilerImpl:
    def __init__(self, *args, **kwargs):
        ...
        # Convert field names into index column names
        # Note: this overrides Elasticsearch7SearchQueryCompiler
        # by using autocomplete fields instead of searchable fields
        if self.fields:
            fields = []
...
class Elasticsearch7SearchBackend(BaseSearchBackend):
    ...
    def __init__(self, params):
        ...
        self.settings = deepcopy(self.settings)  # Make the class settings attribute as instance settings attribute
