...
describe('FocusController', () => {
  ...
  describe('using to skip to a specific element', () => {
    ...
    it('should focus on the section top when the button is clicked', () => {
      expect(document.activeElement).toBe(document.body);
  ...
  describe('avoid modifying tabindex if not required', () => {
    ...
    it('should focus on the section top when the button is clicked & when focus is removed keep the tabindex', () => {
      expect(document.activeElement).toBe(document.body);
