...
When working with SVG images, you can use the `preserve_svg` in filter string to prevent operations that would require rasterizing the SVG.
...
For SVG images, you can use the `preserve_svg` in filter string to ensure they remain as vector graphics:
