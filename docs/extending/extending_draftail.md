...
To write the React components, Wagtail exposes its own React, Draft.js and Draftail dependencies as global variables. Read more about this in [extending client-side components](extending_client_side_react_components).
...
It also uses dependencies from global variables – see [Extending client-side components](extending_client_side_react_components).
