...
class PageListingEditButton(PageDropdownItemButton):
    label = _("Edit")
    icon_name = "edit"
...
class PageListingViewDraftButton(PageDropdownItemButton):
    label = _("View draft")
    icon_name = "draft"
...
class PageListingViewLiveButton(PageDropdownItemButton):
    label = _("View live")
    icon_name = "doc-empty"
...
class PageListingAddChildPageButton(PageDropdownItemButton):
...
class PageListingMoveButton(PageDropdownItemButton):
    label = _("Move")
...
class PageListingCopyButton(PageDropdownItemButton):
    label = _("Copy")
    icon_name = "copy"
...
class PageListingDeleteButton(PageDropdownItemButton):
    label = _("Delete")
    icon_name = "bin"
...
class PageListingUnpublishButton(PageDropdownItemButton):
    label = _("Unpublish")
    icon_name = "download"
...
class PageListingHistoryButton(PageDropdownItemButton):
    label = _("History")
    icon_name = "history"
...
class PageListingSortMenuOrderButton(PageDropdownItemButton):
