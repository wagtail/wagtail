 ...
 * The `wagtail.models.UserPagePermissionsProxy` class has been removed; equivalent functionality exists in the `wagtail.permission_policies.pages.PagePermissionPolicy` class.
