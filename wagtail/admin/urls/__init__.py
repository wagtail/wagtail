...
urlpatterns = [
    ...
    url(
        r"^choose-page/search/$", chooser.search, name="wagtailadmin_choose_page_search"
    ),
    url(
    ...
    url(
        r"^tag-autocomplete/$", tags.autocomplete, name="wagtailadmin_tag_autocomplete"
    ),
    url(
        r"^collections/",
    ...
    url(
        r"account/change_avatar/$",
        account.change_avatar,
        name="wagtailadmin_account_change_avatar",
    ),
    url(
...
urlpatterns += [
    ...
    url(
        r"^userbar/(\d+)/$", userbar.for_frontend, name="wagtailadmin_userbar_frontend"
    ),
    url(
        r"^userbar/moderation/(\d+)/$",
