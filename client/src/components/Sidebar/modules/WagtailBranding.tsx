...
const WagtailBranding: React.FunctionComponent<WagtailBrandingProps> = ({ homeUrl, images, strings, navigate }) => {
  ...
  return (
    <a className={desktopClassName} href="#" onClick={onClick} aria-label={strings.DASHBOARD} onMouseMove={onMouseMove} onMouseLeave={onMouseLeave}>
      <div className="sidebar-wagtail-branding__icon-wrapper">
        ...
        <img className="sidebar-wagtail-branding__icon" data-part="eye--closed" src={images.desktopLogoEyeClosed} alt="" />
      </div>
    </a>
  );
};
