...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'wagtailredirects.redirect': {
            ...
            'redirect_page': ('django.db.models.fields.related.ForeignKey', [],
                              {'blank': 'True', 'related_name': "'+'", 'null': 'True',
                               'to': u"orm['wagtailcore.Page']"}),
            'site': ('django.db.models.fields.related.ForeignKey', [],
                     {'blank': 'True', 'related_name': "'redirects'", 'null': 'True', 'to': u"orm['wagtailcore.Site']"})
        }
    }
