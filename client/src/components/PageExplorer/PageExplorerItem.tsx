 ...
 */
const PageExplorerItem: React.FunctionComponent<PageExplorerItemProps> = ({ item, onClick }) => {
  ...
  return (
    <div className="c-page-explorer__item">
      <Button href={`${ADMIN_URLS.PAGES}${id}/`} className="c-page-explorer__item__link">
