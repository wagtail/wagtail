...
class TestDbWhitelister(TestCase):
    ...
    def test_page_link_is_rewritten(self):
        ...
        expected = '<p>Look at the <a linktype="page" id="2">lovely homepage</a>'
        ' of my <a href="http://wagtail.io/">Wagtail</a> site</p>'
        self.assertHtmlEqual(expected, output_html)

    def test_document_link_is_rewritten(self):
        input_html = '<p>Look at our <a data-linktype="document" data-id="1" href="/documents/1/brochure.pdf">'
    ...
    def test_image_embed_is_rewritten(self):
        input_html = '<p>OMG look at this picture of a kitten:</p><figure data-embedtype="image" data-id="5"'
        ...
        output_html = DbWhitelister.clean(input_html)
        expected = '<p>OMG look at this picture of a kitten:</p><embed embedtype="image" id="5"'
        ' format="image-with-caption" alt="A cute kitten" />'
        self.assertHtmlEqual(expected, output_html)

    def test_media_embed_is_rewritten(self):
        input_html = '<p>OMG look at this video of a kitten: '
        '<iframe data-embedtype="media" data-url="https://www.youtube.com/watch?v=dQw4w9WgXcQ" width="640" height="480"'
        ' src="//www.youtube.com/embed/dQw4w9WgXcQ" frameborder="0" allowfullscreen></iframe></p>'
        output_html = DbWhitelister.clean(input_html)
        expected = '<p>OMG look at this video of a kitten:'
    ...
    def test_div_conversion(self):
        ...
        input_html = '<p>before</p><div class="shiny">OMG <b>look</b> at this <blink>video</blink> of a kitten: '
        '<iframe data-embedtype="media" data-url="https://www.youtube.com/watch?v=dQw4w9WgXcQ" width="640" height="480"'
        ' src="//www.youtube.com/embed/dQw4w9WgXcQ" frameborder="0" allowfullscreen></iframe></div><p>after</p>'
        output_html = DbWhitelister.clean(input_html)
        expected = '<p>before</p><p>OMG <b>look</b> at this video of a kitten:'
    ...
    def test_whitelist_hooks(self):
        ...
        input_html = '<blockquote>I would put a tax on all people who'
        ' <a href="https://twitter.com/DMReporter/status/432914941201223680/photo/1" target="_blank" tea="darjeeling">'
        'stand in water</a>.</blockquote><p>- <character>Gumby</character></p>'
        output_html = DbWhitelister.clean(input_html)
        expected = '<blockquote>I would put a tax on all people who'
        ...
        expected = 'I would put a tax on all people who'
        ' <a href="https://twitter.com/DMReporter/status/432914941201223680/photo/1">stand in water</a>.<p>- Gumby</p>'
        self.assertHtmlEqual(expected, output_html)
