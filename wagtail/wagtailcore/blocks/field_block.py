...
class PageChooserBlock(ChooserBlock):
    ...
    def __init__(self, can_choose_root=False, page_model=None, **kwargs):
    ...
    def target_model(self):
        ...
        return self.page_model or Page

    @cached_property
    def widget(self):
        from wagtail.wagtailadmin.widgets import AdminPageChooser
        return AdminPageChooser(target_models=[self.page_model], can_choose_root=self.can_choose_root)
