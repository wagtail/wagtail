...
urlpatterns = [
    ...
    path('multiple/create_from_uploaded_document/<int:uploaded_document_id>/', multiple.CreateFromUploadedDocumentView.as_view(), name='create_multiple_from_uploaded_document'),
