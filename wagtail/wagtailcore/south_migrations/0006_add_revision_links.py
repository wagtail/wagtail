...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.first_revision'
        db.add_column('wagtailcore_page', 'first_revision',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.PageRevision']),
                      keep_default=False)

        # Adding field 'Page.last_revision'
        db.add_column('wagtailcore_page', 'last_revision',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailcore.PageRevision']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.first_revision'
        db.delete_column('wagtailcore_page', 'first_revision_id')

        # Deleting field 'Page.last_revision'
        db.delete_column('wagtailcore_page', 'last_revision_id')
    ...
    models = {
        ...
        'wagtailcore.page': {
            ...
            'first_revision': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['wagtailcore.PageRevision']"}),
            'go_live_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'has_unpublished_changes': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_revision': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['wagtailcore.PageRevision']"}),
