...
All this while, you have been adding content to your site in the local enviroment. Now that you fave deployed your site to server, you have to add content to live site. To add content your live site, go to ` https://yourname-wagtail-portfolio.fly.dev/admin/` in your browser follow the steps in the following sub-sections of the tutorial:
