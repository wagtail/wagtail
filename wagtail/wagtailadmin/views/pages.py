        ...
        if form.is_valid():
            ...
            if is_publishing:
                if page.go_live_at and page.go_live_at > timezone.now():
                    messages.success(request, _("Page '{0}' created and scheduled for publishing.").format(page.get_title_for_display()), buttons=[
                        messages.button(reverse('wagtailadmin_pages:edit', args=(page.id,)), _('Edit'))
                    ])
                else:
                    messages.success(request, _("Page '{0}' created and published.").format(page.get_title_for_display()), buttons=[
                ...
                messages.success(
                    request,
                    _("Page '{0}' created and submitted for moderation.").format(page.get_title_for_display()),
                    buttons=[
                ...
                messages.success(request, _("Page '{0}' created.").format(page.get_title_for_display()))
...
def delete(request, page_id):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, _("Page '{0}' deleted.").format(page.get_title_for_display()))
...
def unpublish(request, page_id):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, _("Page '{0}' unpublished.").format(page.get_title_for_display()), buttons=[
            messages.button(reverse('wagtailadmin_pages:edit', args=(page.id,)), _('Edit'))
        ])
...
def move_confirm(request, page_to_move_id, destination_id):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, _("Page '{0}' moved.").format(page_to_move.get_title_for_display()), buttons=[
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if form.cleaned_data.get('copy_subpages'):
                messages.success(
                    request,
                    _("Page '{0}' and {1} subpages copied.").format(page.get_title_for_display(), new_page.get_descendants().count())
                )
            else:
                messages.success(request, _("Page '{0}' copied.").format(page.get_title_for_display()))
...
def approve_moderation(request, revision_id):
    ...
    if not revision.submitted_for_moderation:
        messages.error(request, _("The page '{0}' is not currently awaiting moderation.").format(revision.page.get_title_for_display()))
        return redirect('wagtailadmin_home')

    if request.method == 'POST':
        revision.approve_moderation()
        messages.success(request, _("Page '{0}' published.").format(revision.page.get_title_for_display()), buttons=[
...
def reject_moderation(request, revision_id):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, _("Page '{0}' rejected for publication.").format(revision.page.get_title_for_display()), buttons=[
            messages.button(reverse('wagtailadmin_pages:edit', args=(revision.page.id,)), _('Edit'))
        ])
...
def lock(request, page_id):
    ...
    if not page.locked:
        ...
        messages.success(request, _("Page '{0}' is now locked.").format(page.get_title_for_display()))
...
def unlock(request, page_id):
    ...
    if page.locked:
        ...
        messages.success(request, _("Page '{0}' is now unlocked.").format(page.get_title_for_display()))
