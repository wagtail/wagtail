    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='The name of the page as it will appear in URLs e.g http://domain.com/blog/[my-slug]/', max_length=255, verbose_name='Slug')),
                ...
                ('go_live_at', models.DateTimeField(blank=True, help_text='Please add a date-time in the form YYYY-MM-DD hh:mm.', null=True, verbose_name='Go live date/time')),
                ('expire_at', models.DateTimeField(blank=True, help_text='Please add a date-time in the form YYYY-MM-DD hh:mm.', null=True, verbose_name='Expiry date/time')),
                ('expired', models.BooleanField(default=False, editable=False, verbose_name='Expired')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pages', to='contenttypes.ContentType', verbose_name='Content type')),
                ('owner', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owned_pages', to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
                ...
                ('first_published_at', models.DateTimeField(editable=False, null=True, verbose_name='First published at')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission_type', models.CharField(choices=[('add', 'Add/edit pages you own'), ('edit', 'Add/edit any page'), ('publish', 'Publish any page'), ('lock', 'Lock/unlock any page')], max_length=20, verbose_name='Permission type')),
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(db_index=True, default=False, verbose_name='Submitted for moderation'),
        ),
        migrations.AlterModelOptions(
            name='grouppagepermission',
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(db_index=True, editable=False, null=True, verbose_name='First published at'),
        ),
        migrations.AlterField(
            model_name='grouppagepermission',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='page_permissions', to='auth.Group', verbose_name='group'),
        ),
        migrations.AlterField(
            model_name='grouppagepermission',
            name='page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_permissions', to='wagtailcore.Page', verbose_name='page'),
        ),
        migrations.AlterField(
            model_name='grouppagepermission',
            name='permission_type',
        ...
        migrations.AlterField(
            model_name='page',
            name='content_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pages', to='contenttypes.ContentType', verbose_name='content type'),
        ),
        migrations.AlterField(
            model_name='page',
            name='expire_at',
            field=models.DateTimeField(blank=True, help_text='Please add a date-time in the form YYYY-MM-DD hh:mm.', null=True, verbose_name='expiry date/time'),
        ),
        migrations.AlterField(
            model_name='page',
            name='expired',
        ...
        migrations.AlterField(
            model_name='page',
            name='go_live_at',
            field=models.DateTimeField(blank=True, help_text='Please add a date-time in the form YYYY-MM-DD hh:mm.', null=True, verbose_name='go live date/time'),
        ),
        migrations.AlterField(
            model_name='page',
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(editable=False, null=True, verbose_name='latest revision created at'),
        ),
        migrations.AlterField(
            model_name='page',
            name='live',
        ...
        migrations.AlterField(
            model_name='page',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owned_pages', to=settings.AUTH_USER_MODEL, verbose_name='owner'),
        ),
        migrations.AlterField(
            model_name='page',
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(blank=True, null=True, verbose_name='approved go live at'),
        ),
        migrations.AlterField(
            model_name='pagerevision',
            name='content_json',
        ...
        migrations.AlterField(
            model_name='pagerevision',
            name='page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='revisions', to='wagtailcore.Page', verbose_name='page'),
        ),
        migrations.AlterField(
            model_name='pagerevision',
            name='submitted_for_moderation',
        ...
        migrations.AlterField(
            ...
            name='page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='view_restrictions', to='wagtailcore.Page', verbose_name='page'),
        ),
        migrations.AlterField(
            model_name='pageviewrestriction',
            name='password',
        ...
        migrations.AlterField(
            model_name='site',
            name='root_page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sites_rooted_here', to='wagtailcore.Page', verbose_name='root page'),
        ),
        migrations.AddField(
            model_name='site',
            name='site_name',
            field=models.CharField(blank=True, help_text='Human-readable name for the site.', max_length=255, null=True, verbose_name='site name'),
        ),
        migrations.AlterField(
            model_name='pagerevision',
            name='user',
