...
- Create a new document model that inherits from
  ``wagtail.contrib.documents.models.AbstractDocument``. This is where you would
...
.. code-block:: python
    ...
    # models.py
    from wagtail.contrib.documents.models import Document, AbstractDocument
...
.. module:: wagtail.contrib.documents
