...
class StreamFieldBlockPreview(TemplateView):
    ...
    @cached_property
    def page_title(self):
        return gettext("Preview for %(block_type)s: %(block_name)s block") % {
            "block_type": self.block_def.__class__.__name__,
            "block_name": self.block_def.label,
        }
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update(self.block_def.get_preview_context(self.block_value, context))
        return context
