...
def fragment(parser, token):
    ...
    Adopted from `slippers' fragment template tag <https://github.com/mixxorz/slippers/blob/254c720e6bb02eb46ae07d104863fce41d4d3164/slippers/templatetags/slippers.py#L173>`_ with a few tweaks.
