...
class TestV3RedirectListing(WagtailTestUtils, TestCase):
    def setUp(self):
        super().setUp()
    ...
    def test_anonymous_returns_401(self):
        ...
        assert_problem_response(self, response, status_code=401)
    ...
    def test_user_without_any_redirect_permission_gets_403(self):
        ...
        response = self.get_response()
        assert_problem_response(self, response, status_code=403)


class TestV3RedirectDetail(WagtailTestUtils, TestCase):
    def setUp(self):
        super().setUp()
...
class TestV3RedirectCreate(WagtailTestUtils, TestCase):
    def setUp(self):
        super().setUp()
        self.valid_payload = {
...
class TestV3RedirectUpdate(WagtailTestUtils, TestCase):
    def setUp(self):
        super().setUp()
        self.redirect = make_redirect(
...
class TestV3RedirectDelete(WagtailTestUtils, TestCase):
    def setUp(self):
        super().setUp()
        self.redirect = make_redirect(
