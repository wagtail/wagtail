...
class TestV3SiteListing(WagtailTestUtils, TestCase):
...
class TestV3SiteDetail(WagtailTestUtils, TestCase):
    fixtures = ["demosite.json"]
...
class TestV3SiteCreate(WagtailTestUtils, TestCase):
    fixtures = ["demosite.json"]
...
class TestV3SiteUpdate(WagtailTestUtils, TestCase):
    fixtures = ["demosite.json"]
...
class TestV3SiteDelete(WagtailTestUtils, TestCase):
    fixtures = ["demosite.json"]
