...
$(function () {
  const $wagtailspace = $(
    '<a href="https://www.wagtail.space/2019/" class="wagtailspace" title="https://www.wagtail.space/2019/">' +
    ...
    '  <div>' +
    '    <strong>Wagtail Space</strong><br> 13 – 15 March 2019 Arnhem, The&nbsp;Netherlands' +
    '  </div>' +
    '  <span class="close" title="Hide banner">×</span>' +
    '</a>'
  );

  if (!hasCookie('wagtailspaceClosed', 'true')
    && new Date() < new Date(2019, 2, 15)) {
    $('.wy-nav-content').prepend($wagtailspace);
    $wagtailspace.find('.close').click(function (e) {
      e.preventDefault();
      setCookie('wagtailspaceClosed', 'true', 30);
      $wagtailspace.detach();
    });
  }
