...
.. note::
    ...
    Wagtail depends on the Pillow package for image manipulation. On some platforms Pillow require additional steps to get images working in Wagtail. `More information here <http://pillow.readthedocs.org/en/latest/installation.html#os-x-installation>`_
