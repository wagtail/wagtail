...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'wagtailcore_grouppagepermission', ['group_id', 'page_id', 'permission_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'GroupPagePermission', fields ['group', 'page', 'permission_type']
        db.delete_unique(u'wagtailcore_grouppagepermission', ['group_id', 'page_id', 'permission_type'])
