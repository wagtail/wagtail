...
class Page(AbstractPage, index.Indexed, ClusterableModel, metaclass=PageBase):
    ...
    def _ensure_unique_slug(self):
        """
        Ensures the current slug is unique within its parent context.

        - If the slug field is empty, auto-generate it from the title.
        - If the slug already present , generate new.
        """
