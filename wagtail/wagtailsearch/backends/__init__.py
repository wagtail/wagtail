...
# TODO: Replace this with "from django.utils.module_loading import
# import_string" when django 1.7 is released
...
def get_search_backend(backend='default', **kwargs):
    ...
    try:
        # Try to get the WAGTAILSEARCH_BACKENDS entry for the given backend
        # name first
