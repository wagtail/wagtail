...
[](content_personalization) is a new advanced how-to guide explaining how to meet common content personalization requirements with built-in features, such as combining [`BlockGroup`](wagtail.blocks.BlockGroup) in StreamField and [preview modes](wagtail.models.AbstractPage.preview_modes) to create segmented page sections. This guide was written by Thibaud Colas.
...
Wagtail recently underwent an independent code security audit commissioned by the [Interministerial Digital Directorate (DINUM)](https://www.numerique.gouv.fr/) of France. Check out the [audit findings and our action plan](https://wagtail.org/blog/independent-security-audit-findings-and-next-steps/). Here are specific changes in this release made in accordance to those findings:

* Add [](wagtaildocs_max_upload_size) setting for specifying maximum document file size (Om Harsh)
* Set the [project template](project_templates_reference) `WAGTAILDOCS_MAX_UPLOAD_SIZE` to 10MB (Thibaud Colas)
* Update [audit log actions docs](audit_log) to cover all currently-logged actions(Thibaud Colas)
* Document more approaches to mitigating untrusted file uploads when [storing and serving documents](storing_and_serving) (Thibaud Colas)
* Document common patterns for [logging and monitoring](logging_and_monitoring) on Wagtail projects
* Clarify default value for for [`WAGTAILDOCS_SERVE_METHOD`](wagtaildocs_serve_method) (Thibaud Colas)
* Document [security reporting policy](security_reporting) about runtime vs. development dependencies (Thibaud Colas)
* Upgrade CodeQL security scanning to cover more parts of the codebase (Thibaud Colas)
...
Many thanks to Seoyoung Kang from AhnLab and an independent security researcher for reporting this issue. For further details, please see [security advisory GHSA-c6wj-9vcj-75pj](https://github.com/wagtail/wagtail/security/advisories/GHSA-c6wj-9vcj-75pj).
...
Many thanks to Seoyoung Kang from AhnLab and an independent security researcher for reporting this issue. For further details, please see [security advisory GHSA-c4mr-889m-vgf6](https://github.com/wagtail/wagtail/security/advisories/GHSA-c4mr-889m-vgf6).
...
Many thanks to Sanjok Karki and an independent security researcher for reporting this issue. For further details, please see [security advisory GHSA-67rv-mg8q-5pf3](https://github.com/wagtail/wagtail/security/advisories/GHSA-67rv-mg8q-5pf3).
...
Many thanks to Sanjok Karki and an independent security researcher for reporting this issue. For further details, please see [security advisory GHSA-p5gm-92h4-6pv6](https://github.com/wagtail/wagtail/security/advisories/GHSA-p5gm-92h4-6pv6).
