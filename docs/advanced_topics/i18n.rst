...
This is a minimal user interface that allows to create copies of translatables (pages and snippets) into another language.
...
and run ``python manage.py migrate`` to create the necessary permissions.
