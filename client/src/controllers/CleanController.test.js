...
describe('CleanController', () => {
  ...
  describe('compare', () => {
    ...
    it('should prevent default using the slugify (default) behaviour as the compare function when urlify values is not equal', async () => {
    ...
    it('should not prevent default using the slugify (default) behaviour as the compare function when urlify value is equal', async () => {
      const slug = document.querySelector('#id_slug');
    ...
    it('should not prevent default using the urlify behaviour as the compare function when urlify value matches', async () => {
      const title = 'Тестовий заголовок';
