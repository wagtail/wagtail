 ...
 * Add the ability to restrict what types of requests a Page supports via [`allowed_http_methods`](#wagtail.models.AbstractPage.allowed_http_methods) (Andy Babic)
 ...
 * Update example for customizing ["p-as-heading" accessibility check](built_in_content_checker) without overriding built-in checks (Cynthia Kiser)
