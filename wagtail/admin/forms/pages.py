...
class WagtailAdminPageForm(WagtailAdminModelForm):
    ...
    def __init__(self, data=None, files=None, parent_page=None, *args, **kwargs):
        ...
        # In case the title is generated, the slug will not be automatically filled by the JS
        # in the frontend. This code sets the field as "not required" so that the slug is 
        # automatically generated by the backend in Page.full_clean().
        if self.instance.has_generated_title:
