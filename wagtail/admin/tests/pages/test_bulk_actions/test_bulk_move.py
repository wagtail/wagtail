...
class TestBulkMove(TestCase, WagtailTestUtils):
    ...
    def setUp(self):
        ...
        self.url = reverse('wagtailadmin_bulk_action', args=(self.section_c.id, 'move')) + f'?id={self.test_page_b.id}&id={self.test_page_b_1.id}'
    ...
    def test_user_without_bulk_delete_permission_can_move(self):
        ...
        response = self.client.get(
            reverse('wagtailadmin_bulk_action', args=(self.root_page.id, 'move')) + f'?id={self.unpublished_page.id}'
        )
