...
class TestPageChooserPanel(TestCase):
    ...
    def test_render_js_init(self):
        ...
        expected_js = 'new PageChooser("{id}", {{"modelNames": ["{model}"], "canChooseRoot": false, "userPerms": null, "locale": null, "modalUrl": "/admin/choose-page/", "parentId": {parent}}});'.format(
    ...
    def test_render_js_init_with_can_choose_root_true(self):
        ...
        expected_js = 'new PageChooser("{id}", {{"modelNames": ["{model}"], "canChooseRoot": true, "userPerms": null, "locale": null, "modalUrl": "/admin/choose-page/", "parentId": {parent}}});'.format(
            id="id_page", model="wagtailcore.page", parent=self.events_index_page.id
        )
        self.assertIn(expected_js, result)
