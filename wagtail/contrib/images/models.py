...
from wagtail.contrib.images.image_operations import (
    FilterOperation, ImageTransform, TransformOperation)
from wagtail.contrib.images.rect import Rect
...
logger = logging.getLogger("wagtail.contrib.images")
