    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                models.CharField(
                    ...
                    max_length=255,
                    validators=[wagtail.contrib.forms.models.validate_to_address], verbose_name='to address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='demosite.formpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
