...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PagePublishLog'
        db.create_table('wagtailcore_pagepublishlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='publish_log', to=orm['wagtailcore.Page'])),
            ('revision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='publish_log', to=orm['wagtailcore.PageRevision'])),
            ('published_at', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('wagtailcore', ['PagePublishLog'])
    ...
    def backwards(self, orm):
        # Deleting model 'PagePublishLog'
        db.delete_table('wagtailcore_pagepublishlog')

        # Deleting field 'Page.first_publish'
        db.delete_column('wagtailcore_page', 'first_publish_id')

        # Deleting field 'Page.last_publish'
        db.delete_column('wagtailcore_page', 'last_publish_id')
    ...
    models = {
        ...
        'wagtailcore.pagepublishlog': {
            'Meta': {'object_name': 'PagePublishLog'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'publish_log'", 'to': "orm['wagtailcore.Page']"}),
            'published_at': ('django.db.models.fields.DateTimeField', [], {}),
            'revision': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'publish_log'", 'to': "orm['wagtailcore.PageRevision']"})
        },
