...
When loading fixtures of models containing foreign keys to the Locale model, missing values would be automatically filled with the default Locale. This could break the setup of TransactionTestCase, values to this foreign must now be explicitely referenced in the fixture.
