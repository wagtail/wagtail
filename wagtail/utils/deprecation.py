...
class RemovedInWagtail211Warning(DeprecationWarning):
    pass


removed_in_next_version_warning = RemovedInWagtail211Warning


class RemovedInWagtail212Warning(PendingDeprecationWarning):
    pass
