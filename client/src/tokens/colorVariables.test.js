    ...
    expect(colorVariables).toMatchInlineSnapshot(`
      {
        ...
        "--w-color-info-100-hue": "calc(var(--w-color-info-125-hue) - 0.3)",
        "--w-color-info-100-lightness": "calc(var(--w-color-info-125-lightness) + 8.5%)",
        "--w-color-info-100-saturation": "calc(var(--w-color-info-125-saturation) + 0.3%)",
