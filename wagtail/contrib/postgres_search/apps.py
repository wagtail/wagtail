...
from wagtail.utils.deprecation import RemovedInWagtail216Warning as RemovedInWagtail217Warning
...
class PostgresSearchConfig(AppConfig):
    ...
    def ready(self):
        ...
        warnings.warn('The postgres_search app will be deprecated in a future release. Please update your search backend to \'wagtail.search.backends.database\', which will pick up a Postgres backend automatically.', RemovedInWagtail217Warning)
