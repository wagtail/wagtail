  ...
  describe("getPageChildren", () => {
    it("works", () => {
      ...
      expect(client.get).toBeCalledWith(
        `${ADMIN_API.PAGES}?child_of=3&for_explorer=1`
      );
    });
    ...
    it("#fields", () => {
      ...
      expect(client.get).toBeCalledWith(
        `${ADMIN_API.PAGES}?child_of=3&for_explorer=1&fields=title%2Clatest_revision_created_at`
      );
    });
    ...
    it("#onlyWithChildren", () => {
      ...
      expect(client.get).toBeCalledWith(
        `${ADMIN_API.PAGES}?child_of=3&for_explorer=1&has_children=1`
      );
    });
    ...
    it("#offset", () => {
      ...
      expect(client.get).toBeCalledWith(
        `${ADMIN_API.PAGES}?child_of=3&for_explorer=1&offset=5`
      );
    });
  });
