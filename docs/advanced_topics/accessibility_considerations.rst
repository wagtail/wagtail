...
- For rich text – Wagtail already makes it possible to customize alt text for rich text images. Unfortunately it’s not currently possible to elect not to provide alt text for decorative images (see `#6494 <https://github.com/wagtail/wagtail/issues/6494>`_).
