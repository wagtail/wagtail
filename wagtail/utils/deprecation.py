...
class RemovedInWagtail210Warning(DeprecationWarning):
    pass


removed_in_next_version_warning = RemovedInWagtail210Warning


class RemovedInWagtail211Warning(PendingDeprecationWarning):
    pass
