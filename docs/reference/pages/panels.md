...
.. class:: FieldPanel(field_name, classname=None, widget=None, heading='', disable_comments=False, permission=None)
    ...
    .. attribute:: FieldPanel.disable_comments (optional)
        ...
        This allows you to prevent a field level comment button showing for this panel if set to ``True``. See `Create and edit comments <https://guide.wagtail.org/en-4.1.x/how-to-guides/manage-pages/#create-and-edit-comments>`_.
