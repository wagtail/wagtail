...
### MySQL database backend may work unreliably

Due to to [`some very specific behavior`](https://github.com/wagtail/wagtail/issues/9477) of MySQL and in particular, mysqlclient, usage of MySQL as a database backend may lead to unreliable behavior.
