...
The ``indexed_fields`` is now deprecated and has been replaced by a new search field configuration format called ``search_fields``.

TODO: Needs docs!


Page.route method should now return a RouteResult instead of an HttpResponse
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

TODO


Hooks have been moved into wagtailcore
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
